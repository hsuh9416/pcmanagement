...
public class Seat12 extends JButton implements Runnable {
	...
	public Seat12() {
		...
		name = new JLabel("[12¹ø] ºó ÁÂ¼®",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			if(dao.getOnOff(12)==0) {
				...
				String text1 ="[12]¹ø   "+dao.getName(12)+" ´Ô";
				String text2 ="ÀÜ¿©½Ã°£  :  "+(dao.getTime(12)/60)+" ½Ã°£"
						+(dao.getTime(12)%60)+"  ºÐ";
				name.setText(text1);
