...
public class Seat10 extends JButton implements Runnable {
	...
	public Seat10() {
		...
		name = new JLabel("[10¹ø] ºó ÁÂ¼®",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			if(dao.getOnOff(10)==0) {
				...
				String text1 ="[10]¹ø   "+dao.getName(10)+" ´Ô";
				String text2 ="ÀÜ¿©½Ã°£  :  "+(dao.getTime(10)/60)+" ½Ã°£"
						+(dao.getTime(10)%60)+"  ºÐ";
				name.setText(text1);
