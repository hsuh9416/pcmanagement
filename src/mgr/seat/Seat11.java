...
public class Seat11 extends JButton implements Runnable {
	...
	public Seat11() {
		...
		name = new JLabel("[11¹ø] ºó ÁÂ¼®",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			if(dao.getOnOff(11)==0) {
				...
				String text1 ="[11]¹ø   "+dao.getName(11)+" ´Ô";
				String text2 ="ÀÜ¿©½Ã°£  :  "+(dao.getTime(11)/60)+" ½Ã°£"
						+(dao.getTime(11)%60)+"  ºÐ";
				name.setText(text1);
